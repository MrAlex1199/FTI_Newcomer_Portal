...
export default function GlobalSearch({ onSelect, className = '' }) {
  const { t } = useLanguage();
  ...
  return <div ref={rootRef} className={`relative w-full ${className || 'sm:w-64 lg:w-72'}`}>
    <SearchBar
      value={query}
      onSearch={(value) => {
        setQuery(value);
